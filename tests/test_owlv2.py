        ...
        self.local_test_images = [
            {
                ...
                "expected_boxes": torch.tensor(
                    [
                        [871.6295, 356.4588, 986.3647, 575.9403],
                        [1301.3206, 445.8857, 1444.1129, 579.8057],
                        [654.3935, 463.4556, 769.7889, 702.1123],
                        [874.6709, 611.9890, 1018.6308, 760.7022],
                        [1255.5255, 496.7317, 1403.3069, 778.6777],
                    ],
                    device="cpu",
                ),
                "text": [
            ...
            },
            {
                ...
                "expected_labels": [
                    ...
                    "a photo of a Hershey's chocolate box",
                    "a photo of a Monster can",
                    "a photo of a Pocky box",
                    "a photo of a Coca-Cola can",
                    "a photo of a Pringles can",
                ],
                "expected_boxes": torch.tensor(
                    [
                        [222.4883, 203.3190, 367.4705, 578.4133],
                        [779.8372, 360.5367, 908.2158, 586.8098],
                        [336.7640, 471.6024, 569.4174, 906.2870],
                        [648.7751, 497.6859, 872.6106, 740.7831],
                        [875.3945, 498.3228, 1121.1078, 782.7988],
                        [548.6553, 212.7347, 759.6924, 419.4795],
                    ],
                    device="cpu",
                ),
                "text": [
